...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		TArray<struct FInputCore_FKey>                     InKeys                                                     (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	 */
	void UInputKeySelector::SetEscapeKeys(TArray<struct FInputCore_FKey> InKeys)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FInputCore_FKey                             DragKey                                                    (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	struct FEventReply UWidgetBlueprintLibrary::DetectDragIfPressed(const struct FPointerEvent& PointerEvent, class UWidget* WidgetDetectingDrag, const struct FInputCore_FKey& DragKey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FInputCore_FKey                             DragKey                                                    (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	struct FEventReply UWidgetBlueprintLibrary::DetectDrag(struct FEventReply* Reply, class UWidget* WidgetDetectingDrag, const struct FInputCore_FKey& DragKey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FInputCore_FKey                             Key                                                        (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void UWidgetInteractionComponent::ReleasePointerKey(const struct FInputCore_FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FInputCore_FKey                             Key                                                        (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UWidgetInteractionComponent::ReleaseKey(const struct FInputCore_FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FInputCore_FKey                             Key                                                        (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void UWidgetInteractionComponent::PressPointerKey(const struct FInputCore_FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		bool                                               bRepeat                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UWidgetInteractionComponent::PressKey(const struct FInputCore_FKey& Key, bool bRepeat)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FInputCore_FKey                             Key                                                        (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UWidgetInteractionComponent::PressAndReleaseKey(const struct FInputCore_FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
