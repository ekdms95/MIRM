...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DamageFontTextActor_NORMALSUFFERED_BP.DamageFontTextActor_NORMALSUFFERED_BP_C
	 * Size -> 0x0020 (FullSize[0x0330] - InheritedSize[0x0310])
	 */
	class ADamageFontTextActor_NORMALSUFFERED_BP_C : public ADamageFontTextActor
	{
	public:
	...
	public:
		...
		void OnPreSet();
		void ExecuteUbergraph_DamageFontTextActor_NORMALSUFFERED_BP(int32_t EntryPoint);
