...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass CM_Btn_Minus_R.CM_Btn_Minus_R_C
	 * Size -> 0x0050 (FullSize[0x0430] - InheritedSize[0x03E0])
	 */
	class UCM_Btn_Minus_R_C : public UButtonPrefab
	{
	public:
		...
		class UMirButton*                                          Minus_btn;                                               // 0x03F0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UMirTextBlock*                                       MinusTitle_txt;                                          // 0x03F8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class FName                                                RichTextStyleSet;                                        // 0x0428(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void SetNumberText(int32_t NewParam);
		void MinusIconStatus(const class FName& MinusimgStatus);
		...
		void ExecuteUbergraph_CM_Btn_Minus_R(int32_t EntryPoint);
