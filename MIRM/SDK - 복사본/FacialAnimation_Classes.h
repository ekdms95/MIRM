...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1A9C[0x8];                                   // 0x0860(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1BVJ[0x2C];                                  // 0x0874(0x002C) MISSED OFFSET (PADDING)
