...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_AN7T[0xA8];                                  // 0x0000(0x00A8) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_D4XX[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	 ...
	 * Size -> 0x0030
	 */
	struct FInteractiveToolsFramework_FActiveGizmo
	{
	public:
		unsigned char                                              UnknownData_WQXE[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_G3F7[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
