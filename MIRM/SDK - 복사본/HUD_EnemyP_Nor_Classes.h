...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass HUD_EnemyP_Nor.HUD_EnemyP_Nor_C
	 * Size -> 0x0010 (FullSize[0x0330] - InheritedSize[0x0320])
	 */
	class UHUD_EnemyP_Nor_C : public UHUDEnemyGaugeElementPrefab
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_HUD_EnemyP_Nor(int32_t EntryPoint);
