...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass TeleportScreenEffectArrive_BP.TeleportScreenEffectArrive_BP_C
	 * Size -> 0x0054 (FullSize[0x0274] - InheritedSize[0x0220])
	 */
	class ATeleportScreenEffectArrive_BP_C : public AActor
	{
	public:
		...
		unsigned char                                              UnknownData_O7JZ[0x4];                                   // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KHQC[0x7];                                   // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_TeleportScreenEffectArrive_BP(int32_t EntryPoint);
