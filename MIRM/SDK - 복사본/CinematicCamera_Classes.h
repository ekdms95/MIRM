...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NF55[0x2];                                   // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_3ZRY[0x3];                                   // 0x0225(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_EXOE[0x10];                                  // 0x0810(0x0010) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0100 (FullSize[0x08E0] - InheritedSize[0x07E0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_WCOE[0xC];                                   // 0x0874(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GNTL[0x8];                                   // 0x08D8(0x0008) MISSED OFFSET (PADDING)
