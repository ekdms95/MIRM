...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DamageFontTextActor_ImmuneSelf_BP.DamageFontTextActor_ImmuneSelf_BP_C
	 * Size -> 0x0020 (FullSize[0x0330] - InheritedSize[0x0310])
	 */
	class ADamageFontTextActor_ImmuneSelf_BP_C : public ADamageFontTextActor
	{
	public:
	...
	public:
		...
		void OnPreSet();
		void ExecuteUbergraph_DamageFontTextActor_ImmuneSelf_BP(int32_t EntryPoint);
