...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DamageFontTextActor_EVASION_BP.DamageFontTextActor_EVASION_BP_C
	 * Size -> 0x0020 (FullSize[0x0330] - InheritedSize[0x0310])
	 */
	class ADamageFontTextActor_EVASION_BP_C : public ADamageFontTextActor
	{
	public:
	...
	public:
		...
		void OnBeginPlay();
		void OnPreSet();
		void ExecuteUbergraph_DamageFontTextActor_EVASION_BP(int32_t EntryPoint);
