...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3V5R[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_YHVK[0x3];                                   // 0x0024(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
