...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass HUD_Dm_Mana.HUD_Dm_Mana_C
	 * Size -> 0x0020 (FullSize[0x0340] - InheritedSize[0x0320])
	 */
	class UHUD_Dm_Mana_C : public UMirFontUserWidget
	{
	public:
	...
	public:
		...
		void OnSetText();
		void Destruct();
		void ExecuteUbergraph_HUD_Dm_Mana(int32_t EntryPoint);
