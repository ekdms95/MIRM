...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass HUD_Dm_Resist_Self.HUD_Dm_Resist_Self_C
	 * Size -> 0x0030 (FullSize[0x0350] - InheritedSize[0x0320])
	 */
	class UHUD_Dm_Resist_Self_C : public UMirFontUserWidget
	{
	public:
	...
	public:
		...
		void OnSetText();
		void Destruct();
		void ExecuteUbergraph_HUD_Dm_Resist_Self(int32_t EntryPoint);
